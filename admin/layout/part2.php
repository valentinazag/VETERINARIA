  ...
  <!-- Footer -->
  <footer class="main-footer text-center text-white" style="background-color:rgb(27, 31, 34);">
    <strong>Copyright © 2025 <a href="#">Valentina Zagman</a>.</strong>
    All rights reserved.
  </footer>
</div> <!-- fin .wrapper -->
<!-- ./wrapper -->
